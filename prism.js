　/* PrismJS 1.27.0
https://prismjs.com/download.html#themes=prism-dark&languages=markup+css+clike+javascript+c+csharp+cpp+json+json5&plugins=line-highlight+line-numbers+toolbar+copy-to-clipboard+download-button */
        ...
        var t = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i,
            ...
            M = {
                ...
                highlight: function (e, n, t) {
                    ...
                    if (M.hooks.run("before-tokenize", r), !r.grammar) throw new Error('The language "' + r.language + '" has no grammar.');
                    return r.tokens = M.tokenize(r.code, r.grammar), M.hooks.run("after-tokenize", r), W.stringify(M.util.encode(r.tokens), r.language)
                },
                                        ...
                                        for (var p = c.pattern || c, m = a.next, y = i; m !== t.tail && !(l && y >= l.reach); y += m.value.length, m = m.next) {
                                            ...
                                            if (!(k instanceof W)) {
                                                ...
                                                if (h) {
                                                    ...
                                                    for (var P = m; P !== t.tail && (E < A || "string" == typeof P.value); P = P.next) b++, E += P.value.length;
